...
Tries to read the loader config from the `webpack.dev.conf.js` under the given property name (`"myLoader"` in this case) and merges the result with the loader query. For example, if your `webpack.dev.conf.js` had this property...
